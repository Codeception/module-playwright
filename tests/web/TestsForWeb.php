...
use Codeception\Module\Playwright;
...
{
    protected ?Playwright $module = null;
    ...
    #[Skip('Should work according to CodeceptJS docs...')]
    ...
    public function testSeeInFieldOnTextarea()
    {
        ...
        $this->module->seeInField('//textarea[@id="description"]', 'sunrise');
    }
    ...
    public function testDontSeeInFieldOnInput()
    {
        ...
        $this->module->dontSeeInField('//input[@id="name"]', 'Davert');
    }
    ...
    public function testDontSeeInFieldOnTextarea()
    {
        ...
        $this->module->dontSeeInField('//textarea[@id="description"]', 'sunset');
    }
    ...
    public function testGrabValueFrom()
    {
        ...
        $result = $this->module->grabValueFrom("//form/descendant::input[@name='action']");
        $this->assertSame("kill_people", $result);
        $this->module->amOnPage('/form/textarea');
    ...
    public function testDontSeeElementOnPageFails()
    {
        $this->shouldFail();
        $this->module->amOnPage('/form/field');
        $this->module->dontSeeElement('//input[@id="name"]');
    }
    ...
    public function testStrictLocators()
    {
        ...
        $this->module->seeElement(['xpath' => '//*[@tabindex = normalize-space(4)]']);
    }
